 ...
 * @author ricar
 */
public class UpPlaga extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnGuardar.setText("Guardar Plaga");
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        try {
            ...
            plaga.setNomEspecie(txtNomCientifico.getText());
            plaga.setNombreComun(txtNomComun.getText());

            // Llamar al DAO para guardar en BD
            Clases.dao.PlagaDAO plagaDAO = new Clases.dao.PlagaDAO();
            boolean guardado = plagaDAO.insertar(plaga);
