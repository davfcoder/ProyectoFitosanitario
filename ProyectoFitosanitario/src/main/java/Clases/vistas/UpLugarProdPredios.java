...
public class UpLugarProdPredios extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("A continuación, se presenta una lista de los predios disponibles. Puedes seleccionar uno o más, según lo requieras:");
        ...
        jLabel3.setText("Una vez seleccionado el o los predios que conformarán el lugar de producción, presiona \"Guardar Predios en el Lugar\" para guardar ");
    ...
    if (selectedRows.length < 1) {
        ...
        if (asociados > 0){
            JOptionPane.showMessageDialog(
                this,
                asociados + " predio(s) asociado(s) correctamente al Lugar de Producción: " + nombreLP
            );
