 ...
 * @author ricar
 */
public class GestionPlagas extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnNuevaPlaga = new javax.swing.JButton();
        ...
        jLabel1.setText("Gestión de Plagas:");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "Nombre Cientifico", "Nombre Comun"
            }
        ));
        ...
        btnNuevaPlaga.setText("+ Nueva Plaga");
        btnNuevaPlaga.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnNuevaPlagaActionPerformed(evt);
            }
        });
    ...
    private void btnBorrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBorrarActionPerformed
        ...
        if (selected.length < 1) {
            JOptionPane.showMessageDialog(this, "Debes seleccionar uno o más Plagas para eliminar.", "AVISO", JOptionPane.WARNING_MESSAGE);
        } else {
            int confirmacion = JOptionPane.showConfirmDialog(
                    this,
                    "¿Está seguro de eliminar las Plagas seleccionadas?",
            ...
            if (confirmacion == JOptionPane.YES_OPTION) {
                ...
                for (int idx = selected.length - 1; idx >= 0; idx--) {
                    ...
                    try {
                        String idPlaga = jTable1.getValueAt(row, 0).toString();
                        boolean ok = dao.eliminar(idPlaga);
                        if (ok) {
                            model.removeRow(row);
                            eliminados++;
                        } else {
                            ...
                            JOptionPane.showMessageDialog(
                                    this,
                                    "No se pudo eliminar la Plaga con ID: " + idPlaga,
                                    "Error",
                ...
                if (eliminados > 0) {
                    JOptionPane.showMessageDialog(this, eliminados + " Plaga(s) eliminadas correctamente.");
                } else {
                    JOptionPane.showMessageDialog(this, "No se eliminó ninguna plaga.");
                }
            } else {
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        if (fila == -1) {
            JOptionPane.showMessageDialog(this, "Por favor, seleccione una plaga de la tabla para editarlo.");
            return;
        }

        // Supongamos que la columna 0 tiene el número de identificación
        String idPlaga = jTable1.getValueAt(fila, 0).toString();

        // Buscar la plaga en la BD
        try {
            // Buscar la plaga en la BD
            Clases.dao.PlagaDAO buscarId = new Clases.dao.PlagaDAO();
            Clases.modelo.Plaga plaga = buscarId.buscarPorId(idPlaga);
            ...
            if (plaga != null) {
                ...
                JOptionPane.showMessageDialog(this, "No se encontró la plaga seleccionada.");
            }
    ...
    private javax.swing.JButton btnNuevaPlaga;
