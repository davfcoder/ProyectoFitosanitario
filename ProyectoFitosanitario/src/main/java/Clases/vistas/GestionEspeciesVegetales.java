...
import Clases.vistas.UpEspecieVegetal;
 ...
 * @author ricar
 */
public class GestionEspeciesVegetales extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnNuevaEspecieVegetal = new javax.swing.JButton();
        ...
        jLabel1.setText("Gestión de Especies Vegetales:");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "Nombre Cientifico", "Nombre Comun", "Ciclo Cultivo"
            }
        ));
        ...
        btnNuevaEspecieVegetal.setText("+ Nueva Especie Vegetal");
        btnNuevaEspecieVegetal.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnNuevaEspecieVegetalActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(btnNuevaEspecieVegetal)
                .addGap(40, 40, 40)
    ...
    private void btnBorrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBorrarActionPerformed
        ...
        if (selected.length < 1) {
            JOptionPane.showMessageDialog(this, "Debes seleccionar uno o más Especies Vegetales para eliminar.", "AVISO", JOptionPane.WARNING_MESSAGE);
        } else {
            int confirmacion = JOptionPane.showConfirmDialog(
                    this,
                    "¿Está seguro de eliminar las Especies Vegetales seleccionadas?",
            ...
            if (confirmacion == JOptionPane.YES_OPTION) {
                ...
                for (int idx = selected.length - 1; idx >= 0; idx--) {
                    ...
                    try {
                        String idEspecie = jTable1.getValueAt(row, 0).toString();
                        boolean ok = dao.eliminar(idEspecie);
                        if (ok) {
                            model.removeRow(row);
                            eliminados++;
                        } else {
                            ...
                            JOptionPane.showMessageDialog(
                                    this,
                                    "No se pudo eliminar la Especies Vegetales con ID: " + idEspecie,
                                    "Error",
                ...
                if (eliminados > 0) {
                    JOptionPane.showMessageDialog(this, eliminados + " Especies Vegetale(s) eliminadas correctamente.");
                } else {
                    JOptionPane.showMessageDialog(this, "No se eliminó ninguna Especies vegetales.");
                }
            } else {
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        if (fila == -1) {
            JOptionPane.showMessageDialog(this, "Por favor, seleccione una Especies vegetales de la tabla para editarlo.");
            return;
        }

        // Supongamos que la columna 0 tiene el número de identificación
        String idEspecie = jTable1.getValueAt(fila, 0).toString();

        // Buscar la Especie Vegetal en la BD
        try {
            // Buscar la especie vegetal en la BD
            Clases.dao.EspecieVegetalDAO buscarId = new Clases.dao.EspecieVegetalDAO();
            Clases.modelo.EspecieVegetal especievegetal = buscarId.buscarPorId(idEspecie);
            ...
            if (especievegetal != null) {
                ...
                JOptionPane.showMessageDialog(this, "No se encontró la Especie Vegetal seleccionada.");
            }

        } catch (Exception e) {
            JOptionPane.showMessageDialog(this,
                    "Error al obtener la especie vegetal: " + e.getMessage(),
                    "Error",
                    JOptionPane.ERROR_MESSAGE);
            e.printStackTrace();
        }
    ...
    private javax.swing.JButton btnNuevaEspecieVegetal;
