 ...
 * @author ricar
 */
public class EditRol extends javax.swing.JPanel {
    ...
    public void setRol(Roles rol) {
        ...
        txtNomRol.setText(rol.getNomRol());
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        ...
                        .addComponent(txtDescripcion, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 662, Short.MAX_VALUE)))
                .addGap(68, 68, 68))
        );
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (rolActual == null) {
            JOptionPane.showMessageDialog(this, "No hay un Rol cargado para actualizar.");
            return;
        }
        ...
        try {
            ...
            rolActual.setNomRol(txtNomRol.getText());
            rolActual.setDescripcion(txtDescripcion.getText());

            // Llamar al DAO para actualizar en BD
            RolesDAO rolesDAO = new RolesDAO();
            boolean actualizado = rolesDAO.actualizar(rolActual);
