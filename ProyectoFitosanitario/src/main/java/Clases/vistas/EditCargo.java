 ...
 * @author ricar
 */
public class EditCargo extends javax.swing.JPanel {
    ...
    public void setCargo(Cargo cargo) {
        ...
        txtNomCargo.setText(cargo.getNomCargo());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Editar Cargo Existente: ");
        ...
        jButton2.setText("Actualizar Cargo");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (cargoActual == null) {
            JOptionPane.showMessageDialog(this, "No hay un cargo cargado para actualizar.");
            return;
        }
        ...
        try {
            ...
            cargoActual.setNomCargo(txtNomCargo.getText());
            cargoActual.setDescripcion(txtDescripcion.getText());

            // Llamar al DAO para actualizar en BD
            CargoDAO cargoDAO = new CargoDAO();
            boolean actualizado = cargoDAO.actualizar(cargoActual);
